...
!function (e, t, n) {
  ...
  function h(e, t, o, i) {
    ...
    for (var f, d, p, h, v, g = ["modernizr", "tspan", "samp"]; !T.style && g.length;)f = !0, T.modElem = s(g.shift()), T.style = T.modElem.style;
    for (p = e.length, d = 0; p > d; d++)if (h = e[d], v = T.style[h], a(h, "-") && (h = l(h)), T.style[h] !== n) {
  ...
  function v(e, t, n, o, i) {
    var a = e.charAt(0).toUpperCase() + e.slice(1), s = (e + " " + w.join(a + " ") + a).split(" ");
    return r(t, "string") || r(t, "undefined") ? h(s, t, o, i) : (s = (e + " " + N.join(a + " ") + a).split(" "), c(s, t, n))
  }
  ...
  var S = t.documentElement, b = "svg" === S.nodeName.toLowerCase();
  b || !function (e, t) {
    function n(e, t) {
    ...
    function a(e, n, r) {
      ...
      r || (r = i(n));
      var o;
      return o = r.cache[e] ? r.cache[e].cloneNode() : C.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !o.canHaveChildren || E.test(e) || o.tagUrn ? o : r.frag.appendChild(o)
    }
    ...
    function m(e) {
      ...
      return !T || e.printShived ? e : ("undefined" == typeof s[_] && s.add(_), l.attachEvent("onbeforeprint", function () {
          t();
          for (var i, a, s, l = e.styleSheets, u = [], f = l.length, p = Array(f); f--;)p[f] = l[f];
          for (; s = p.pop();)if (!s.disabled && N.test(s.media)) {
            try {
    ...
    var h, v, g = "3.7.3", y = e.html5 || {}, E = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, C = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, S = "_html5shiv", b = 0, x = {};
    !function () {
      try {
    ...
    e.html5 = w, u(t);
    var N = /^$|\b(?:all|print)\b/, _ = "html5shiv", T = !v && function () {
  ...
  var x = "Moz O ms Webkit", w = C._config.usePrefixes ? x.split(" ") : [];
  C._cssomPrefixes = w;
  var N = C._config.usePrefixes ? x.toLowerCase().split(" ") : [];
  C._domPrefixes = N;
  var _ = {elem: s("modernizr")};
  Modernizr._q.push(function () {
    delete _.elem
  });
  var T = {style: _.elem.style};
  Modernizr._q.unshift(function () {
    delete T.style
  }), C.testAllProps = v, C.testAllProps = g, Modernizr.addTest("flexbox", g("flexBasis", "1px", !0)), o(), i(y), delete C.addTest, delete C.addAsyncTest;
